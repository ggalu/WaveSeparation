...
# @Last Modified time: 2024-12-01 21:02:58
...
locA = L_inputbar * 0.1
locB = L_inputbar * 0.9 #+ L_specimen + 0.1 * L_outputbar
locC = L_inputbar + L_specimen * 0.5
...
endTime = 2.287 #2.05 * 2 * L_inputbar / c0 #
...
history_elems = np.zeros((N_x,num_timesteps),float) #Global solution
...
eps_A = history_elems[idxA,:]
eps_B = history_elems[idxB,:]
eps_C = history_elems[idxC,:]
