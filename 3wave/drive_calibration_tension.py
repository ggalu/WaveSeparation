...
with the specimen replaced by a single element of bar material, so the assembly
is one uniform bar and the joint reflects nothing, driven by a short striker so
that every echo is a clean isolated pulse.
